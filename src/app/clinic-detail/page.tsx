          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-start">
              ...
              <div className="space-y-3">
                <h1 className="text-3xl font-bold font-serif text-gray-900">{clinicData.name}</h1>
                ...
                <div className="flex flex-wrap items-center gap-y-2 gap-x-4 text-sm text-gray-600 font-medium">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-900 mr-1">{clinicData.rating}</span>
                    <span className="text-gray-400 font-normal">({clinicData.reviews} reviews)</span>
                  </div>
                  {/* Hours */}
                  <div className="flex items-center">
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed text-sm md:text-base">
                <p>Radiant Skin Clinic is a premier aesthetic medical facility specializing in advanced skin rejuvenation and anti-aging treatments. With over 15 years of experience, our board-certified dermatologists and aesthetic specialists are dedicated to helping you achieve your beauty goals.</p>
                <p>We combine cutting-edge technology with personalized care to deliver exceptional results in a comfortable, luxurious environment.</p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {highlights.map((item) => (
                  <div key={item.id} className="bg-[#faf8f6] px-5 py-4 rounded-xl flex items-center gap-3 border border-gray-100/50">
                    <span className="text-xl bg-[#f5ced2]/20 p-2 rounded-lg">{item.icon}</span>
                  ...
                  <div key={item.id} className="border border-gray-100 rounded-2xl p-6 flex flex-col md:flex-row justify-between gap-6 hover:shadow-md transition-shadow bg-white">
                    ...
                    <div className="space-y-3 flex-1">
                      ...
                      <div className="flex items-center gap-4 text-sm font-medium text-gray-600 pt-2">
                        ...
                        <div className="flex items-center">
                          <svg className="w-4 h-4 text-yellow-400 mr-1" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
                          {item.rating} <span className="text-gray-400 font-normal ml-1">({item.reviews} reviews)</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-row md:flex-col items-center md:items-end justify-between md:justify-center shrink-0 border-t md:border-t-0 md:border-l border-gray-100 pt-4 md:pt-0 md:pl-6">
                      <div className="text-2xl font-bold text-gray-900 md:mb-3">{item.price}</div>
