      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-y-2 gap-x-6 text-sm text-gray-600 font-medium">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-gray-900 font-bold mr-1">{treatmentData.rating}</span>
                  <span className="text-gray-400 font-normal">({treatmentData.reviewsCount} reviews)</span>
                </div>
                {/* Duration */}
                <div className="flex items-center">
                ...
                <div className="flex items-center text-[#dcb5b9] font-semibold">
                  <svg className="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1v1H9V7zm5 0h1v1h-1V7zm-5 4h1v1H9v-1zm5 0h1v1h-1v-1zm-5 4h1v1H9v-1zm5 0h1v1h-1v-1z" /></svg>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {suitableFor.map((item, index) => (
                  <div key={index} className="bg-[#faf8f6] px-5 py-4 rounded-xl flex items-center gap-3 border border-gray-100/50">
                    <svg className="w-5 h-5 text-green-500 bg-green-100 rounded-full p-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* 5. Expected Results */}
            <div>
              <h2 className="text-xl font-bold font-serif mb-4 text-gray-900">Expected Results</h2>
              <div className="bg-[#faf8f6] p-6 rounded-2xl border border-gray-100/50 space-y-4">
                <div className="flex items-start gap-3">
                  <span className="text-[#dcb5b9] mt-0.5">📅</span>
                  <div>
                    <span className="font-bold text-gray-900">Timeline:</span> <span className="text-gray-600">Results visible within 3-7 days, full effect at 2 weeks</span>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-[#dcb5b9] mt-0.5">⏳</span>
                  <div>
                    <span className="font-bold text-gray-900">Duration:</span> <span className="text-gray-600">Results last 3-6 months on average</span>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-[#dcb5b9] mt-0.5">✨</span>
                  <div>
                    <span className="font-bold text-gray-900">Outcome:</span> <span className="text-gray-600">Smoother, refreshed appearance with reduced wrinkles</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-[#fffbeb] p-6 rounded-2xl border border-yellow-100">
                  <h3 className="font-bold text-gray-900 mb-2">Before Treatment</h3>
                ...
                <div className="bg-[#eff6ff] p-6 rounded-2xl border border-blue-100">
                  <h3 className="font-bold text-gray-900 mb-2">After Treatment</h3>
                  <ul className="list-disc list-inside text-gray-600 space-y-1 text-sm md:text-base">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="sticky top-24 bg-[#faf8f6] rounded-2xl p-6 md:p-8 border border-gray-100 shadow-sm">
              ...
              <div className="text-center mb-6">
                ...
                <h3 className="text-4xl font-bold text-gray-900 mb-1">{treatmentData.price}</h3>
              ...
              <div>
                ...
                <ul className="space-y-4 text-sm">
                  {treatmentDetailsCard.map((detail, idx) => (
                    <li key={idx} className="flex justify-between items-center border-b border-gray-200/60 pb-3 last:border-0 last:pb-0">
